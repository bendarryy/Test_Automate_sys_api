...
class Product(models.Model):
    ...
    system = models.ForeignKey(System, on_delete=models.CASCADE, related_name='products')
...
class StockChange(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)  # This is the correct field for timestamp
